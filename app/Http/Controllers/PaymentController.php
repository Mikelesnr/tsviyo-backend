...
class PaymentController extends Controller
{
     ...
     *
     * Sends a mock payment using the FakePaymentProvider and records it in the database.
     *
     * @authenticated
     *
     ...
     * @bodyParam method string optional The payment method used. Default is "fake_card". Example: wallet
     *
     * @response 201 {
